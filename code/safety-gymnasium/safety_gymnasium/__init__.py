...
# Goal Environments
# ----------------------------------------
goal_tasks = {'GoalBase': {'task_name': 'GoalBase'}, 'Goal0': {}, 'Goal1': {}, 'Goal2': {}, 'Goal3': {}}
...
__register_helper(
    ...
    entry_point='safety_gymnasium.tasks.safe_velocity.safety_ant_velocity_v2:SafetyAntVelocityEnv',
    max_episode_steps=1000,
    reward_threshold=6000.0,
)
...
__register_helper(
    env_id='SafetyHalfCheetahVelocity-v2',
    entry_point='safety_gymnasium.tasks.safe_velocity.safety_half_cheetah_velocity_v2:SafetyHalfCheetahVelocityEnv',
    max_episode_steps=1000,
    reward_threshold=4800.0,
)

__register_helper(
    env_id='SafetyHalfCheetahVelocity-v3',
    entry_point='safety_gymnasium.tasks.safe_velocity.safety_half_cheetah_velocity_v3:SafetyHalfCheetahVelocityEnv',
    max_episode_steps=1000,
    reward_threshold=4800.0,
)
...
__register_helper(
    ...
    entry_point='safety_gymnasium.tasks.safe_velocity.safety_half_cheetah_velocity_v4:SafetyHalfCheetahVelocityEnv',
    max_episode_steps=1000,
    reward_threshold=4800.0,
)
...
__register_helper(
    ...
    entry_point='safety_gymnasium.tasks.safe_velocity.safety_half_cheetah_velocity_v5:SafetyHalfCheetahVelocityEnv',
    max_episode_steps=1000,
    reward_threshold=4800.0,
)
